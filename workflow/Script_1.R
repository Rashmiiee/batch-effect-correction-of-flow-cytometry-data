setwd("~/Desktop/Flow_Cytometry_Trail/Data_for_MDS_plots")
library(readxl)
library(flowCore)
md <- read_excel("metadata_file.xlsx")
md$condition <- factor(md$condition,levels = c("Unstimulated","Stimulated"))
...
fcs <- fsApply(fcs_raw, function(x, cofactor = 80){
