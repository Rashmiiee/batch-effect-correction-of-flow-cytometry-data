...
getMinEventCount <- function(anchorKeyword="anchor stim", basedir="Desktop/Flow_Cytometry_Trail/Scripts_and_Data_for_MDS and markerintensity_plots/T cell panel/CytofBatchAdjust_try"){
